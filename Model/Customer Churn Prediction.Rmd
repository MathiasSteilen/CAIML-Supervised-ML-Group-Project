...
bind_rows(
  ...
  ggplot(aes(x = model %>% reorder_within(by = -mean, within = .metric), 
             y = mean, 
             colour = .config)) +
...
**Which model to use here? Is specificity the most important one? Create profit curves for each model with different metrics? Create profit curves for each metric with different models?**
