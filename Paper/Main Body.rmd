...
This project was undertaken to design a profit-maximizing customer churn prediction model based on fictional data from a telecommunication company. A gradient boosting model, a k-nearest neighhbours model, a random forest model, a logistic regression model, a support vector machines model and a blended model have been created. Then, the models have been evaluated based on an exemplifying business case. Besides the marginally better, but very complex blended model, the random forest model generated the most profit. However, logistic regression only generated three percent less profit impact than the random forest model. Therefore, the simple logistic regression was recommended to function as a starting point to effectively retain dissatisfied customers through discounts. Further work needs to be done to fully understand how customers react to personalized discount programs and to better grasp the real-world effectiveness of more complex models. Whilst this study did not include customers attempts at outsmarting the model to receive discounts, it did provide a hands-on starting point for developing customer churn prediction models in the telecommunication industry. 
