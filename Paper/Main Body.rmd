...
mydata2 %>%
  kable(align = 'llll', format = 'latex', 
        caption = "Evaluation of Procedural Fairness \\label{tab:FairnessTable}", booktabs = TRUE, linesep = "") %>% 
  kable_styling(full_width = FALSE, latex_options = c("striped"))%>%
  kable_paper() %>%
