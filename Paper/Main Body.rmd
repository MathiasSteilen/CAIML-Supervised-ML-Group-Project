...
getethicstable<-function(def_topic_category,def_category1,def_category2){
  ...
  #important prediction - churn                                 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  row_category1<-c(churn_category1,pred_category1,total_category1,label_percent()(churn_category1/total_category1),label_percent()(pred_category1/total_category1),label_percent()(pred_category1/total_category1-churn_category1/total_category1))
  
  
  row_category2<-c(churn_category2,pred_category2,total_category2,label_percent()(churn_category2/total_category2),label_percent()(pred_category2/total_category2),label_percent()(pred_category2/total_category2-churn_category2/total_category2))
  ...
  row_difference<-c(churn_category1-churn_category2,
                    ...
                    label_percent()((pred_category1/total_category1-pred_category2/total_category2)-(churn_category1/total_category1-churn_category2/total_category2)))
  
  data<-c(row_category1,row_category2,row_difference)
  matrix<-matrix(data=data,nrow=6,ncol=3)
  colnames(matrix) <- c(def_category1, def_category2, 'Difference')
  rownames(matrix) <- c('Churn', 'Prediction','Total','Churn %', 'Prediction %',"%'s Difference")
...
kbl(mydata3[c("Prediction","Churn","Total","Prediction %","Churn %","%'s Difference"),]) %>%
  kable_paper() %>%
